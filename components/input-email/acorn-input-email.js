...
/**
 * A email input element.
 *
 * @tagname acorn-input-email
 */
export class AcornInputEmail extends AcornBaseInputElement {
  static properties = {
...
customElements.define('acorn-input-email', AcornInputEmail);
