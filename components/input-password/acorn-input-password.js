 ...
 *
 * @tagname acorn-input-password
 */
export class AcornInputPassword extends AcornBaseInputElement {
  static properties = {
...
customElements.define('acorn-input-password', AcornInputPassword);
